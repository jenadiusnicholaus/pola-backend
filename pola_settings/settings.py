...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,192.168.1.133,192.168.1.181,185.237.253.223,192.168.1.132,192.168.100.187').split(',')
...
# Caching (local memory cache for IP geolocation, etc.)
CACHES = {
    'default': {
