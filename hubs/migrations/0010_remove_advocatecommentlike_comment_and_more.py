...
class Migration(migrations.Migration):
    ...
    operations = [
        # These operations are state-only because the tables were already renamed
        # by migration 0008_rename_to_hub_models using raw SQL.
        # The Advocate* tables no longer exist - they were renamed to Hub* tables.
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                # No database operations - tables were already renamed in 0008
            ],
        ),
        ...
        # ContentBookmark, ContentLike, HubComment, HubCommentLike, HubMessage tables
        # were already created by migrations 0008 (renames) and 0009 (raw SQL creates).
        # Use SeparateDatabaseAndState to register models without creating tables.
        migrations.SeparateDatabaseAndState(
            state_operations=[
            ...
            database_operations=[
                # Tables already exist from 0008 rename and 0009 raw SQL
                # No database operations needed
            ],
        ),
        # Delete the old Advocate models from Django's state (tables were renamed in 0008)
        migrations.SeparateDatabaseAndState(
            state_operations=[
            ...
            database_operations=[
                # No database operations - tables were renamed, not deleted
            ],
        ),
        # Add indexes - wrapped in SeparateDatabaseAndState since indexes may already exist
        migrations.SeparateDatabaseAndState(
            state_operations=[
                migrations.AddIndex(
            ...
            database_operations=[
                # Indexes and unique constraints were already created by 0009 raw SQL
            ],
        ),
    ]
